...
graph(%input, %weight):
    ...
    def test_freeze_module_with_submodule(self):
        ...
        class TestModule(torch.nn.Module):
            ...
            def forward(self, x):
                self.b = 20
                return self.sub1(x) + self.a + self.b + self.sub2(x) + self.sub3(x)
        ...
        self.assertFalse(mf.hasattr('sub3'))
    ...
    def test_freeze_module_detach_gradient(self):
        ...
        print(smod.weight.size())
        # inplace mutation to weight tensor applies to frozen module.
